    ...
    <form @submit.prevent="register">
        <div class="w-1/2 mx-auto">
            <div>
                ...
                <input class="input" id="name" type="text" v-model="form.name" />
            ...
            <div class="mt-4">
                ...
                <input class="input" id="password_confirmation" type="password" v-model="form.password_confirmation" />
            </div>
            <div class="mt-4">
                <button class="btn-primary w-full" type="submit">Register Account</button>
                <div class="mt-2 text-center">
                    <Link class="text-sm text-gray-500" :href="route('login')">Already have an account? Click here</Link>
                </div>
            </div>
        </div>
    </form>
